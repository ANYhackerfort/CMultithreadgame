...
public:
    ...
    void validateChoice(const std::string& choice, const std::string& rightChoice, const std::string& winningMessage = "That's right! Congrats you did not lose any health!", const std::string& losingMessage = "Wrong!");
};
